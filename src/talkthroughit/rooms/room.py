...
class Room:
    ...
    def get_question(self, user_message: str,
        ...
        Returns a tuple of (good_enough, text) where good_enough is whether
        the LLM has determined the user's explanation is sufficient, and text
        is either a clarifying question or a summary of understanding.
        """
